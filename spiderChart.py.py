...
radar.plot(data1, color='red')
radar.plot(data2, color='b')
radar.fill(data1, color='red', alpha=0.2)
radar.fill(data2, color='b', alpha=0.2)
plt.savefig('D:/NowWorking/spidetTest.png', dpi=400,bbox_inches='tight', pad_inches=0.2)
plt.show()
